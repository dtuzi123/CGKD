...
class LifeLone_MNIST(object):
    ...
    def train(self):
        ...
        with tf.Session(config=config) as sess:
            ...
            self.totalSet = []
            self.totalLabel = []
            self.totalSet = np.concatenate((self.InverseMNISTTrain_x, self.FashionTrain_x,
                                            self.InverseFashionTrain_x, self.mnist_train_x, self.svhn_train_x,
                                            self.cifar_train_x),
                                           axis=0)

            self.totalLabel = np.concatenate((self.InverseMNISTTrain_label, self.FashionTrain_label,
                                              self.InverseFashionTrain_label, self.mnist_label, self.svhn_label,
