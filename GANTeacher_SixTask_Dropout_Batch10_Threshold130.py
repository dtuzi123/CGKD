...
class LifeLone_MNIST(object):
    ...
    def train(self):
        ...
        with tf.Session(config=config) as sess:
            ...
            self.SaveImage("Threshold" +str(self.threshold)+ "_SixTask_realbatch", realbatch)
            ...
            self.SaveImage_Small("Threshold" +str(self.threshold)+ "_SixTask_ReaLSmall", myarr)
            self.SaveImage_Small("Threshold" +str(self.threshold)+ "_SixTask_RecoSmall", myarr2)
            ...
            for i in range(self.componentCount):
                ...
                newGan = newGan * 255.0
                newGan = np.reshape(newGan, (-1, 32, 32, 3))
                str2 = "Threshold" +str(self.threshold)+ "_Final_SixTask_" + str(i) + ".png"
                cv2.imwrite(os.path.join("results/", str2),
                            merge2(newGan[:64], [8, 8]))
